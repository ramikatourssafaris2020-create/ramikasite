...
3- Copy the "EDRW Patcher v1.0.exe" app to the
...
[Thanks to De! for KeyGen(Activator)]
======================================================
...
1- "EaseUS hosts blocker.bat" dosyasını çalıştırın ve işlem tamamlandığında aşağıdaki değerlerin
hosts dosyasında olup olmadıklarını kontrol edin, eğer eklenmiş olmayanlar varsa eklenmiş
olmayanları kendiniz ekleyin:
...
*Not: hosts dosyası şu dizinde yer alır:
%SystemRoot%\System32\drivers\etc

2- EaseUS Data Recovery Wizard'ı yükleyin.

3- "EDRW Patcher v1.0.exe" uygulamasını "EaseUS Data Recovery Wizard (x.x(versiyonu varsa))"
yükleme dizinine kopyalayın ve orada çalıştırın, aksi taktirde yamalama işlemi başlamayacaktır.

4- "EDRW v13 Activator v2.1.exe" uygulamasını çalıştırın ve [Activate] butonuna tıklayın, ardından
EaseUS Data Recovery Wizard'ın nerede yüklü bulunduğunu sorduğunda da herhangi bir alt klasör
içerisinde olmayacak şekilde tam olarak "EaseUS Data Recovery Wizard (x.x(versiyonu varsa))"
yükleme dizininin yolunu gösterin.

4- Bitti! ;)

[KeyGen(Aktivatör) için De!'ye teşekkürler]
======================================================
